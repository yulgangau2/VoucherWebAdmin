...
<div id="createvoucher" class="modal fade" role="dialog">
  <div class="modal-dialog text-left">
    ...
    <div class="row hidden-xs">
        <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 card">
            <div class="row">
...
?>
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="thumbnail"><img src="https://udemy-images.udemy.com/course/750x422/62606_8221_7.jpg">
                        <div class="caption text-center">
                            <h4 class="grid text-center">ENGLISH @ CAMT'59 </h4>
 ...
 ?>     
                            ...
                            <div class="row">
                                <div class="col-md-12"><a class="btn btn-primary bold" role="button" href="Details.html">More Details</a></div>
                            </div>
                        </div>
                    </div>
                </div>
